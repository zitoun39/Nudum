...
> **Status**: Superseded by [ADR-0015](./ADR-0015-product-ecosystem.md) — 2026-07-04
...
- Architecture Principle 3: _Modular Monolith First_
- Architecture Principle 4: _Evolution Without Rewrite_
- Architecture Principle 8: _Shared Core Platform_
